...
const InkTonerAccessories = (props) => {
     const {key, img, name, model, availability, price,  Technology, Color, supportedPrinter, printerColor, Yield, SupportedPrinter, PrintingColor, PageYieldDescription, description} = props.toner
    return (
        <div>
                        ...
                        <div id="collage-1" className="collage row">
                            ...
                            <div className=" col-xl-6 p-3 ">
                                <div className="accessories  p-5">
                                    ...
                                    <ul>
                                        <li>Page Yield: {Yield}</li>
                                        <li>Color: {Color}</li>
                                        <li>Printing Technology: {Technology}</li>
                                    </ul>
...
export default InkTonerAccessories;