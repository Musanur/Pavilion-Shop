...
const WorkstationAccessories = (props) => {
       const {key, img, name, model, availability, price, processor, memory, hardDisk, graphics, description, } = props.workstation
    return (
        <div>
                            ...
                            <div className="row">
                                <div className="col-lg-9 col-md-12 specification_Main">
                                    ...
                                    <div className="description" id="description">
                                        <h2>Description :</h2>
                                        <div  itemprop="description"><h1>{name}</h1><p>{description}</p> <br /></div>
                                    </div>
                            </div>
                            </div>
            </div>
...
export default WorkstationAccessories;