...
const AllInOneAccessories = (props) => {
     const { key, img, name, price, model, availability, processor, memory, hardDisk, motherBoard, monitor, graphics, lan, audio, drive, mouse, oparating, keyboard, warranty} = props.allInOne;
    return (
        <div>
                            ...
                            <div className="row">
                                <div className="col-lg-9 col-md-12 specification_Main">
                                    ...
                                    <div className="description" id="description">
                                        <h2>Description :</h2>
                                        <div  itemprop="description"><h1>{name}</h1><p>{name} comes with {processor}, {memory}, {hardDisk}, {graphics}. This All in One PC is designed with 21.5" FHD (1920x1080) Anti-Glare Widescreen Display. {audio} x 1, Security Lock Slot x 1 and DVD RW. This All in One PC supports Integrated Realtek RTL8111HSH-CG GbE, Wi-Fi 5 (802.11ac) and Connectivity. This Gen All in One PC comes with USB Keyboard and mouse. The {name} has 3 years limited warranty.</p></div>
                                    </div>
                            </div>
                            </div>
            </div>
...
export default AllInOneAccessories;