...
const ServerAccessories = (props) => {
     const {key, img, name, model, availability, price, processor, memory, hdd, description, warranty} = props.server
    return (
        <div>
                            ...
                            <div className="row">
                                <div className="col-lg-9 col-md-12 specification_Main">
                                    ...
                                    <div className="description" id="description">
                                        <h2>Description :</h2>
                                        <div  itemprop="description"><h1>{name}</h1><p>{description}</p> <br /><h5>{warranty}</h5></div>
                                    </div>
                            </div>
                            </div>
            </div>
...
export default ServerAccessories;